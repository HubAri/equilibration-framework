...
2. Open executeModel.py and provide relative input paths in lines 20 and 32 
...
```
cd existing_repo
git remote add origin https://gitlab.lrz.de/ge78rey/network-equilibriation.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.lrz.de/ge78rey/network-equilibriation/-/settings/integrations)
